...
<%
	...
	String fileddir1stReport = request.getServletContext().getRealPath("/") + "acq/reports/newArrivalBySch";
	String filedir2ndReport = request.getServletContext().getRealPath("/") + "acq/reports/dummy";
...
<%
	...
	out.println("<thead><tr><td> <b> New Arrival List for School  Reports </b> </td> <td> <b> </b></td></tr></thead><tbody>");
