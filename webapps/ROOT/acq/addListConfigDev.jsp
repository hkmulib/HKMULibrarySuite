...
<thead> <tr> <td> No </td>  <td> School Code <br> (Don't enter "&") </td> <td> School Name </td> <td> Budget Codes </td> <td> Email RPT addr (',' for delimiter.) <br> The 1st entry is the TO-addr while the 2nd and onwards are CC-addr. </td> <td> Delete? </td></tr></thead>
<%
                BufferedReader br = new BufferedReader(new FileReader(budgetCodeFilePath));
                String line = ""; 
                String sch[] = null;
...
<thead>
<tr> <td> School Code <br> (Don't enter "&") </td> <td> School Name </td> <td> Budget Codes </td> <td> Email RPT addr (',' for delimiter) <br>The 1st entry is the TO-addr while the 2nd and onwards are CC-addr. </td></tr>
</thead>
