...
<font color=lightblue size=5> <b>  OUHK LIB CAT's Tools (Testing Site)</b> </font>
<ul>
<li>
</li>
<li>
...
<li>
<a href="pastReport.jsp"> Past Report</a>
</li>
<li>
   <li class='has-sub'><a href='#'><span>Configuration</span></a>
      <ul>
         <li class='has-sub'><a href='ccconfig.jsp'><span>Z39.50 Query</span></a>
         </li>
