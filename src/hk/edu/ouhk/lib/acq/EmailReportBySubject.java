...
/**
 * This class is used with the class FetchReportBySchoolAndDates
 * 
 * @author Wai-yan NG
 * @version 1.0
 * @since Jan 29, 2019
 */
public class EmailReportBySubject {
	 ...
	 * 
	 */
	public EmailReportBySubject(String reportFileStr) {
		Config.init();
		setReportFileStr(reportFileStr);
		setTos(Config.BUDGET_CODES.get(schCode)[2].toString());
		initEmailSystem();
		sendEmail();
	...
	public void sendEmail() {
		...
		try {
			...
			messageBodyPart.setText(
					Config.VALUES.get("NEWARRIVALEMAILGREETING") + "\n\n" + Config.VALUES.get("NEWARRIVALEMAILCONTENT1")
