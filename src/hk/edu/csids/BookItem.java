...
public class BookItem {
	...
	/*
	 * holdingInfo is a 2 dimensional array that each row holds a holding of an
	 * item Col 1 represents "Institution" Col 2 represents "Location" Col 3
	 * represents "Call No." Col 4 represents "Status"
	 */
	...
	private GenStringHandling strHandle = new GenStringHandling();
	...
	/*
	 * getHoldingText() retrieve library holdings of an item and present in a
	 * human readable way.
	 */
	...
	public String stardizePublisherWording(String str) {
		...
		/*
		 * Trim off the publishing place Note: "Lazy" quantifier of regular
		 * expression is used.
		 */
		str = str.replaceAll("^.*?:", "");
